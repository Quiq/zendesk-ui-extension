...
var TicketsComponent = /** @class */ (function () {
    function TicketsComponent(authService, router, envService) {
        ...
        this.setIconsAndTooltips = function (tickets) {
            if (tickets.length < 1) {
                _this.errorMessage = "No previous tickets found";
                return;
            }
            var viaRegEx = /via (\w*)$/;
    ...
    TicketsComponent.prototype.getDataByName = function (name) {
        var _this = this;
        if (name) {
    ...
    TicketsComponent.prototype.getDataByPhone = function (phone) {
        var _this = this;
        if (phone) {
            var a = this.authService
